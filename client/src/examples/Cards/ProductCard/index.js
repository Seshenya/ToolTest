      ...
      <MDBox mt={1} mx={0.5} padding={2}>
        ...
        <MDBox display='flex' justifyContent='space-between' alignItems='center'>
          ...
          <MDBox display='flex' justifyContent='space-evenly' mr={3}>
            ...
            {deleteBtn ? (
              <MDBox display='flex' mr={3}>
                <Tooltip key={'delete'} title={'Delete'} placement='bottom'>
                  <Icon sx={{ color: 'red' }} onClick={() => setDeleteOpen(true)}>
                    delete
                  </Icon>
                </Tooltip>
              </MDBox>
            ...
            >
              <DialogTitle id='delete-title'>Are you sure ?</DialogTitle>
              <DialogActions>
                <MDButton onClick={() => setDeleteOpen(false)}>Yes</MDButton>
                <MDButton onClick={() => setDeleteOpen(false)}>No</MDButton>
              </DialogActions>
            </Dialog>
            {discountCode ? (
            ...
            {collabBtn ? (
              <Tooltip key={'collabSpace'} title={'Open Collab Space'} placement='bottom'>
            ...
            <Dialog
              ...
              aria-describedby='delete-description'
            >
              <DialogTitle id='delete-title'>Generate Discount Code</DialogTitle>
              <DialogContent>
                <MDInput
                  startDecorator={'A'}
                  type='number'
