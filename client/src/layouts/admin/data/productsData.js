...
export default function ProductsTableData({ setUpdateStatusOpen }) {
    ...
    useEffect(() => {
        const token =
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjIsImVtYWlsIjoic2VzaGVueWFAaW5mb3JtYXRpay5ocy1mdWxkYS5kZSIsImlhdCI6MTcwMjIzMDQ3NSwiZXhwIjoxNzAyMjM0MDc1fQ.5vAIsf8X6KSgZpwbIQAsxP4QKz6LZn7tD1Frlpc2-4M'
        ...
        axiosPrivate
            ...
            .then((response) => {
                ...
                if (Array.isArray(fetchedProducts)) {
                    ...
                    console.error(
                        'Invalid data format received from the backend. Expected an array.'
                    )
                }
            })
            .catch((error) => {
